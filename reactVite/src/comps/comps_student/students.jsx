...
const StudentProfile = () => {
  ...
  const { getStudentProfile, updateDetiles } = useStudent();
          ...
          {teacherInfo ? (
            <Card>
              <CardContent>
                ...
                <Typography variant="h6" color="textSecondary" onClick={handleEditModeToggle} style={{ cursor: 'pointer', fontSize: '1.2em' }}>
