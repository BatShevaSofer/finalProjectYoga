...
const CourseCard = ({ data }) => {
  ...
  return (
    <div className='col-md-3 text-center' style={{ width: '30%', margin: '10px', border: '1px solid #ccc', padding: '10px' }}>
